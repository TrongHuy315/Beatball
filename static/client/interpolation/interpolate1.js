...
class InterpolationManager {
    ...
    setupInterpolation() {
        this.scene.SOCKET.on('sendGameState', (data) => {
            ...
            if (data.ball) {
                this.gameInterpolator.updateEntityState('ball', data.ball.position);
            }
        });
    }
    ...
    update() {
        ...
        if (this.scene.ball) {
            const ballState = this.gameInterpolator.getInterpolatedPosition('ball');
            if (ballState) {
                this.scene.ball.setPosition(ballState.position.x, ballState.position.y);
            }
        }
    }
